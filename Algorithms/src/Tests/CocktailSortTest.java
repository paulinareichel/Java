...
import Sorting_Algorithms.CocktailSort;
...
public class CocktailSortTest {
    ...
    public void whenExceptionThrown_thenExpectationSatisfied() {
        Assert.assertNull("Null exception", b.cocktailSort(arr));    }
    ...
    public void checkOutput() {
        ...
        assertArrayEquals(b.cocktailSort(arr), res);
    }
    ...
    public void checkWrongOutput() {
        ...
        assertNotEquals(b.cocktailSort(arr), res);
    }
    @Test
