...
public class BubbleSortTest {
    ...
    public void whenExceptionThrown_thenExpectationSatisfied() {
        Assert.assertNull("Null exception", b.bubbleSort(arr));    }
    ...
    public void checkOutput() {
      ...
      assertArrayEquals(b.bubbleSort(arr), res);
    }
    ...
    public void checkWrongOutput() {
        ...
        assertNotEquals(b.bubbleSort(arr), res);
    }
    ...
    public void shouldNotRumLongerThanTimeout() throws Exception {
        ...
        public void compareOptymisticTimes() {
            ...
            b.bubbleSort(tmp);
            assertThat("Time is above 0.0001s ",  b.timeOfSorting(tmp), is(not( b.timeOfSorting(tmp)<0.0001)));
        }
